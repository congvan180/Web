...
<body>
    ...
    <div class="about_section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-5">
                    <img src="./assetss/images/blog-img1.png" class="about_img" alt="About Image 1">
                    <p class="mt-3">Đây là mô tả về cửa hàng của chúng tôi. Chúng tôi cung cấp các sản phẩm chất lượng cao và dịch vụ tận tâm.</p>
                </div>
                <div class="col-md-7">
                    <img src="./assetss/images/about-img.png" class="about_img" alt="About Image 2">
                </div>
            </div>
        </div>
    </div>
